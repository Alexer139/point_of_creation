...
function notifIcon(type) {
  switch (type) {
    case "invited":
      return '<span class="notif-icon notif-icon--invited">👋</span>';
    case "role_changed":
      return '<span class="notif-icon notif-icon--role">🔑</span>';
    case "removed":
      return '<span class="notif-icon notif-icon--removed">🚪</span>';
    default:
      return '<span class="notif-icon">🔔</span>';
  }
}
