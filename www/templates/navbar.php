...
<nav class="navbar">
  ...
  <?php if (is_logged_in()): ?>
    ...
    <!-- Профиль -->
    <a href="/settings.php" class="nav-user <?= $navbar_active === 'settings' ? 'nav-user--active' : '' ?>"
  ...
  <!-- О проекте -->
  <a href="/about.php" class="btn btn--ghost <?= $navbar_active === 'about' ? 'btn--ghost-active' : '' ?>">
    О проекте
  </a>
  ...
  <?php if (is_logged_in()): ?>
    ...
    <?php if (is_admin()): ?>
      <a href="/admin.php" class="btn btn--admin <?= $navbar_active === 'admin' ? 'btn--admin-active' : '' ?>">
